...
//PersonaServices servicio;
    ...
    @GetMapping("")//El protocolo ya presume que es un get. Esto curre cuando pongo las comillas vacías.
    ...
    @GetMapping("/{id}")
    public ResponseEntity<?> getOne(@PathVariable Long id){//@PathVariable  Toma la variable que viene de la url.
        try{
